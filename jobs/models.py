...
class Job(models.Model):
    ...
    applied_developers = models.ManyToManyField("accounts.User",related_name='developers', verbose_name="Applied Developer")
    developer = models.ForeignKey("accounts.User", verbose_name="Accepted Developer",null=True, on_delete=models.SET_NULL)
